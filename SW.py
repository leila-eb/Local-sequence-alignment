...
def sw_backtrack(seq1,seq2,scores,bt):
	...
	strat_i, start_j, score= 0,0,0
	for i in range(len(seq2)+1):
		for j in range(len(seq1)+1):
			if scores[i][j] > score:
				start_i, start_j, score = i, j, scores[i][j]
	i, j= start_i, start_j #indexes to move through the matrix starting from max value of the scores matrix
...
aln1,aln2,score= sw_backtrack(seq1,seq2,scores,bt)
print(aln1)
print(aln2)
print('Score:',score) 
